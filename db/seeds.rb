...
Shelter.create(sequence: 22, lat: 45.8815981, long: -68.995052, name: "The Birches")
Shelter.create(sequence: 21, lat: 45.3979119, long: -69.4594822, name: "Wilson Valley Lean-to")
Shelter.create(sequence: 20, lat: 44.9957089, long: -70.3412371, name: "Spaulding Mountain Lean-to")
Shelter.create(sequence: 19, lat: 44.3288655, long: -71.1500395, name: "IMP Campsite")
Shelter.create(sequence: 18, lat: 43.8739725, long: -72.0290049, name: "Hexacuba")
Shelter.create(sequence: 17, lat: 43.5235048, long: -72.9126323, name: "Clarendon")
Shelter.create(sequence: 16, lat: 42.6368722, long: -73.1673664, name: "Bascom Lounge")
Shelter.create(sequence: 15, lat: 37.4221543, long: -80.608555, name: "Pine Swamp Brook Lean-to")
Shelter.create(sequence: 14, lat: 41.2683493, long: -74.2678444, name: "Wildcat")
Shelter.create(sequence: 13, lat: 40.9367036, long: -75.1864659, name: "Kirkridge")
Shelter.create(sequence: 12, lat: 39.9319782, long: -77.486416, name: "Quarry Gap")
Shelter.create(sequence: 11, lat: 38.9306324, long: -78.0327781, name: "Manassas Gap")
Shelter.create(sequence: 10, lat: 38.0855703, long: -78.7865632, name: "Calf Mountain")
Shelter.create(sequence: 9, lat: 37.6130592, long: -79.3918448, name: "Johns Hollow")
Shelter.create(sequence: 8, lat: 37.3908569, long: -80.0292814, name: "Campbell")
Shelter.create(sequence: 7, lat: 37.0577631, long: -81.3993256, name: "Chestnut Knob")
Shelter.create(sequence: 6, lat: 36.6832923, long: -81.5110583, name: "Old Orchard")
